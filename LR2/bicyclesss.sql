...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 16 2022 г., 19:52
...
(9, 'schwinn-koen', 'Schwinn Koen 20', 3, 'Schwinn Koen 20 (2022) – это велосипед, сконструированный для детей, возраст которых 5-9 лет. Рама Schwinn Kids Smart Start, steel изготовлена из стали, поэтому её выносливость находится на очень высоким уровне.', 16650),
